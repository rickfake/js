...
^https?://api.revenuecat.com/.+/(receipts$|subscribers/?(.*?)*$) url script-request-header https://raw.githubusercontent.com/rickfake/js/main/qj.js
...
const name = "pro";
const appid = "app.structured.pro.yearly";
